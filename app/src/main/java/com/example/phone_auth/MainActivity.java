...
public class MainActivity extends AppCompatActivity {
    ...
    TextView go_to_log_in_page_from_phone_number,getGo_to_log_in_page_from_email;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getGo_to_log_in_page_from_email=findViewById(R.id.go_to_sign_in_page_from_email);
        ...
        radioButton2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                sign_up_email_btn.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        String editText_email_string=editText_email.getText().toString().trim();
                        String editText_password_string=editText_password.getText().toString().trim();
